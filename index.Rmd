...
For the data preparation, we first prepared the dataset [codebook](https://archive.ics.uci.edu/ml/datasets/Myocardial+Infarction+Complications) which contains detailed description of the variables in our dataset.
...
## Addressing Claa Imbalance using SMOTE
